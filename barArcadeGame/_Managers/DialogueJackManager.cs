...
namespace barArcadeGame._Managers
{
    public class DialogueJackManager
    {
        ...
        public void Init()
        {
            ...
            {
                new Question("Welcome to the Bar, click next to order drinks and foods", new List<string> { }),
                new Question("I am the bar tender Jack, nice to meet you. Are you happy today?", new List<string> { "Yes I am", "No I am not"}),
                new Question("What would you like to do?", new List<string> { "Order drinks", "Order foods"}),

                new Question("What food you would like to order?", new List<string> { "Bread", "Soup", "Pasta" }),
                new Question("Which drink you would like to choose?", result),
