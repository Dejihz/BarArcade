...
namespace rpgGame
{
    public class TileMapManager
    {
        ...
        public void Draw(Matrix matrix, Matrix transformMatrix)//This is where the magic happens :D
        {
            spriteBatch.Begin(//All of these need to be here :(
                 ...
                 transformMatrix: transformMatrix);/*<-This is the main thing*///Strating the drawing to the screen
